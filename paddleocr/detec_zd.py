...
# number_e = sys.argv[5]
# img_path = './photo/61img'
# ini_path = 'photo/ini61'
# rotate = '0'
# type_name = '1'
# number_e = '6'
img_path = "./photo/2001"
template_path ="./photo/ini2001"
threshold = '5'
rotate = '2'
range_d = '1'
number_e = '4'
...
def detect_lcd(path, config, child1):
    ...
    if results:
        ...
        logging.info(f'接收参数：[图片路径：{path}，配置文件路径：{template_path} ]\n识别结果：{results}\n')
    else:
        tree41 = E.BAR_CODE(f"{path}")
        tree42 = E.CHECK_RESULT(
            E.REGION_TYPE("1"),
...
if __name__ == '__main__':
    ...
    if not os.path.exists(img_path):
        ...
        for i in range(int(number_e)):
            ...
            ini = template_path + f'/config{i+1}.ini'
