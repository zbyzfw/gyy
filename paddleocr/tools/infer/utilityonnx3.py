...
def init_args():
    ...
    parser.add_argument("--rec_model_dir", type=str, default='ch_PP-OCRv3_rec_infer_paddle')
    ...
    parser.add_argument("--cls_model_dir", type=str,default='ch_ppocr_mobile_v2.0_cls_infer')
    ...
    args = Dict({
        ...
        'rec_model_dir': 'ch_PP-OCRv3_rec_infer_paddle',
