...
def detect_lcd(path, config, child1):
    ...
    if results:
        ...
        # for res in results:
        if type_name == '1':
            if  '8888.8.8:8.8:8.8' not in results_news:
                nes_meter=['8888.8.8:8.8:88']
            else:
                nes_meter = ['8888.8.8:8.8:8.8']
            for nes in results_news:
                if nes != '8888.8.8:8.8:8.8':
                    nes=nes.replace('.','')
            ...
            if  '8888:8.8:8.8' not in results_news:
                nes_meter=['8888:8.8:88']
            else:
            ...
            if  '8.8.8.8:8.8:8.8' not in results_news:
                nes_meter=['8.8.8.8:8.8:88']
            else:
