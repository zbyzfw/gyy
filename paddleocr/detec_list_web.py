...
# number_e = sys.argv[5]
# img_path = './photo/xiaz0323222'
# ini_path = 'photo/ini03232'
# rotate = '3'
# type_name = '1'
# number_e = '4'
#20版三相
...
def detect_lcd(path, config, child1,rotate,type_name,ini_path):
    # result_list = []
...
def detect_web():
    ...
    ini_path = request.args.get('ini_path')
    rotate = request.args.get('rotate')
    type_name = request.args.get('type_name')
    number_e = request.args.get('number_e')
    if img_path and ini_path and rotate and type_name and number_e:
        # print("取得的参数:",img_path,ini_path,rotate,type_name,number_e)
        pass
    else:
        return {'code':500,'data':'缺少参数','time':time.time()-start}
    root = Element("DATA")
